...
import {
  ...
  Sparkles, Globe, FileText, Moon, Sun, Wallet, Award, ShieldCheck
} from "lucide-react";
  ...
  return (
    ...
    >
        ...
        <div className="hidden md:flex items-center gap-1 flex-shrink-0">
          ...
          {navLink("/how-it-works", "How It Works", "link-how-it-works")}
        ...
        <div className="absolute top-full left-0 right-0 bg-background border-b border-border shadow-xl md:hidden animate-in slide-in-from-top-2 overflow-y-auto max-h-[80vh]">
          <div className="p-4 flex flex-col gap-1">
            {[
              ...
              { href: "/how-it-works", label: "How It Works", icon: ShieldCheck, color: "text-blue-500" },
