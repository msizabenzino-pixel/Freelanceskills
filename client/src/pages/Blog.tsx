  ...
  return (
    <Link href={`/blog/${post.slug}`}>
      <article
        ...
        className="group relative bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden hover:border-emerald-500/50 transition-all duration-300 cursor-pointer">
        <div className="h-80 bg-gradient-to-br from-emerald-900/30 to-gray-900 relative overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            ...
            <p className="text-gray-300 text-base leading-relaxed line-clamp-2 mb-4">{post.excerpt}</p>
...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex flex-col">
      ...
      {/* Hero */}
      <section className="relative bg-gradient-to-b from-gray-900 to-gray-950 border-b border-gray-800 py-16">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-10">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-emerald-900/30 to-gray-900 border border-emerald-600/30 rounded-2xl p-8">
            ...
            <p className="text-gray-400 mb-4 text-sm">Get daily freelance insights delivered to your inbox — SA tax tips, AI tools, tender alerts, and income strategies.</p>
            <div className="flex gap-2">
              <input type="email" placeholder="your@email.co.za" data-testid="input-newsletter-email" className="flex-1 px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 text-sm focus:outline-none focus:border-emerald-500" />
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4">Subscribe via RSS or check our blog sitemap for all published content.</p>
            </div>
            <div className="flex gap-3">
              ...
              <a href="/api/blog/sitemap" target="_blank" data-testid="link-sitemap" className="flex items-center gap-2 px-4 py-2 bg-gray-800 border border-gray-700 text-gray-300 rounded-lg text-sm hover:bg-gray-700 transition-colors">
