            ...
            >
              ...
              <div className="mb-8 space-y-2.5" data-testid="social-login-section">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-dashed border-slate-700/40 text-slate-600 cursor-not-allowed select-none"
                ...
                >
                  ...
                  <span className="text-xs font-medium">Apple <span className="text-slate-600/50 text-[10px]">coming soon</span></span>
                </button>
              </div>
