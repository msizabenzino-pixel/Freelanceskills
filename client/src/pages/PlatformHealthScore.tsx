  ...
  return (
    <div className="min-h-screen p-6" style={{background:"#080d1a"}}>
      <div className="max-w-6xl mx-auto">
        ...
        {tab==="dashboard"&&<div className="rounded-2xl p-8 text-center" style={{background:"rgba(29,191,115,0.07)",border:"1px solid rgba(29,191,115,0.2)"}}><div className="text-8xl font-black text-emerald-400">{d.overall}</div><div className="text-white text-lg mt-2">Platform Health Score — #1 in South Africa</div><div className="text-sm text-gray-500 mt-1">Africa's highest-rated freelance platform — built for 1M freelancers by 2031</div></div>}
      </div>
    </div>
  );
}
