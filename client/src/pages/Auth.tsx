              ...
              {isForgotPassword ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2.5">
                    ...
                    {/* Apple — coming soon, requires Apple Developer account */}
                    <button
                      type="button"
                      disabled
                      title="Apple sign-in coming soon — needs Apple Developer account"
                      className="w-full h-11 rounded-xl font-medium flex items-center justify-center gap-2 px-4 border border-dashed border-border text-muted-foreground/50 cursor-not-allowed select-none"
                    ...
                    >
                      ...
                      <span className="text-xs">Apple <span className="text-[10px] text-muted-foreground/40">coming soon</span></span>
                    </button>
