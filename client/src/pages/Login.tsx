            ...
            >
              ...
              <div className="mb-8" data-testid="social-login-section">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl border border-slate-700 hover:border-[#0077B5] hover:bg-[#0077B5]/10 transition-all text-slate-300 hover:text-white text-sm font-medium"
