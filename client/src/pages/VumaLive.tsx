    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full px-4 py-8 space-y-12">
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-400">One micro-task per day. Bernet completed all 30 before launching — now it's your turn.</p>
            </div>
        ...
        <section className="bg-gradient-to-br from-emerald-950/60 to-blue-950/40 border border-emerald-800/30 rounded-2xl p-8 text-center">
          ...
          <p className="text-xs text-gray-600 mt-4">CIPC 2026/070509/09 · Bernet Msiza · Daveyton → Africa → World</p>
        </section>
      </div>
      <Footer />
    </div>
